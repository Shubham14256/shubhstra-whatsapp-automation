    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="md:ml-64 p-4 md:p-8 pt-20 md:pt-8">
        ...
        <div className="mb-6 md:mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Marketing Suite</h2>
          <p className="text-sm md:text-base text-gray-600">Manage social media, referrals, and campaigns</p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 md:p-8">
              ...
              <button
                ...
                className="w-full md:w-auto bg-green-600 hover:bg-green-700 text-white px-4 md:px-6 py-2 md:py-3 rounded-lg flex items-center justify-center space-x-2 transition-colors disabled:opacity-50 text-sm md:text-base"
