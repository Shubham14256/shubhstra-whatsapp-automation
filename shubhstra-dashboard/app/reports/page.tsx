  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="ml-64 p-8">
        {/* Header */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-800">Patient Reports</h2>
          <p className="text-gray-600">Generate and send PDF reports to patients</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="bg-primary-600 hover:bg-primary-700 text-white px-8 py-3 rounded-lg flex items-center space-x-2 transition-colors disabled:opacity-50"
              disabled={searching}
            >
